...
class NewsListViewController: UIViewController {
    @IBOutlet var headlinesCollection: UICollectionView!
    ...
    func initialSetup() {
        headlinesCollection.contentInsetAdjustmentBehavior = .never
...
extension NewsListViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        if collectionView == headlinesCollection {
            return articleViewModel == nil ? 0 : articleViewModel.article.count
...
extension NewsListViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return newsViewModel == nil ? 0 : newsViewModel.newsarticle.count
    }
